...
changes:
  - version:
    ...
    description: Added __cjsModule: true marker to CJS namespaces
-->
...
These CommonJS namespace objects can also be identified by their `__cjsModule`
export marker.

When importing a CommonJS module, it can thus be reliably imported using the ES
...
// Prints:
//   [Module] { __cjsModule: true, default: <module.exports> }
//   true
```
...
console.log(m);
// Prints: [Module] { __cjsModule: true, default: { name: 'exported' }, name: 'exported' }
```
