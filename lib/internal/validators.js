...
/**
 * @callback validateThis
 * @param {*} context
 * @param {string} className
 * @param {symbol} privateField
 * @returns {asserts context is object}
 */
...
/**
 * @callback validateMissingArgs
 * @param {...[string, any]} args
 * @returns {void}
 */

/** @type {validateMissingArgs} */
const validateMissingArgs = hideStackFrames((...args) => {
